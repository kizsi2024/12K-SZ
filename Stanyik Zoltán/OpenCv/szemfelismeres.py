...
# Előre betanított szemfelismerő modell betöltése
faceCascade = cv2.CascadeClassifier("Resources/haarcascade_eye.xml")
# A 'haarcascade_eye.xml' egy előre betanított modell, amely a szemek felismerésére van kiképezve.
# Ha arcokat szeretnél felismerni, akkor más modellt kell használni, például 'haarcascade_frontalface_default.xml'.

# Kép betöltése
img = cv2.imread("Resources/lena.png")
# Betölti a 'Resources/lena.png' képet a változóba.
...
# A 'detectMultiScale' függvénnyel keresünk szemeket a szürkeárnyalatos képen.
...
# A felismerett szemek köré téglalapot rajzolunk
for (x, y, w, h) in faces:
    # Minden egyes szem koordinátáját és méretét (x, y, szélesség, magasság) tartalmazza a 'faces' változó.
...
# Az 'img' képet a 'Result' ablakban jelenítjük meg, amely tartalmazza a felismerett szemeket.
